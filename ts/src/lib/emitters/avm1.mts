...
export function emitAction(byteStream: ByteStream, value: RawAction): void {
  ...
  const ACTION_TYPE_TO_EMITTER: Map<ActionType, ActionEmitter> = new Map<ActionType, ActionEmitter>([
    [ActionType.Add, 0x0a],
    ...
    [ActionType.ConstantPool, [emitConstantPoolAction, 0x88] as ActionEmitter],
    [ActionType.Decrement, 0x51],
    [ActionType.DefineFunction, [emitDefineFunctionAction, 0x9b] as ActionEmitter],
    [ActionType.DefineFunction2, [emitDefineFunction2Action, 0x8e] as ActionEmitter],
    ...
    [ActionType.GetUrl, [emitGetUrlAction, 0x83] as ActionEmitter],
    [ActionType.GetUrl2, [emitGetUrl2Action, 0x9a] as ActionEmitter],
    [ActionType.GetVariable, 0x1c],
    [ActionType.GotoFrame, [emitGotoFrameAction, 0x81] as ActionEmitter],
    [ActionType.GotoFrame2, [emitGotoFrame2Action, 0x9f] as ActionEmitter],
    [ActionType.GotoLabel, [emitGotoLabelAction, 0x8c] as ActionEmitter],
    [ActionType.Greater, 0x67],
    [ActionType.If, [emitIfAction, 0x9d] as ActionEmitter],
    ...
    [ActionType.Jump, [emitJumpAction, 0x99] as ActionEmitter],
    ...
    [ActionType.Push, [emitPushAction, 0x96] as ActionEmitter],
    ...
    [ActionType.SetTarget, [emitSetTargetAction, 0x8b] as ActionEmitter],
    ...
    [ActionType.StoreRegister, [emitStoreRegisterAction, 0x87] as ActionEmitter],
    [ActionType.StrictEquals, 0x66],
    [ActionType.StrictMode, [emitStrictModeAction, 0x89] as ActionEmitter],
    ...
    [ActionType.Try, [emitTryAction, 0x8f] as ActionEmitter],
    [ActionType.TypeOf, 0x44],
    [ActionType.WaitForFrame, [emitWaitForFrameAction, 0x8a] as ActionEmitter],
    [ActionType.WaitForFrame2, [emitWaitForFrame2Action, 0x8d] as ActionEmitter],
    [ActionType.With, [emitWithAction, 0x94] as ActionEmitter],
  ]);
